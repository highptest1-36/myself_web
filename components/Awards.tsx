...
const Awards = () => {
  ...
  const awards = [
    ...
    },
    {
      ...
      date: "October 2025",
      description: "🥈 Second place in RMIT Hackathon 2025 - Computer Vision Track. Developed innovative AI solution for real-world challenges.",
      image: "/rmit_hackathon (1).jpg",
    ...
    },
    {
      ...
      description: "🏎 Autonomous racing car competition - Top performance in multiple rounds with advanced control algorithms.",
      image: "/car_1.png",
    ...
    },
    {
      ...
      date: "November 2023",
      description: "🎵 Advanced to top 11 in competitive AI music generation challenge using deep learning models.",
      image: "/vibe_code (8).jpg",
